...
summary(perc.aov1)
model.tables(perc.aov1, type = "means") # visualizamos el efecto por m?todo y por grupo
plot(perc.aov1)
###Comparaciones a posteriori
TukeyHSD(perc.aov1, "Group",ordered=T)
TukeyHSD(perc.aov1, "method",ordered=T)
p3=plot(TukeyHSD(perc.aov1, "method",ordered=T))
ggsave(file="plot3.pdf",plot(TukeyHSD(perc.aov1, "method",ordered=T)))
###modelo de an?lisis de la varianza con efectos aleatorios 
