...
This generates a 128-vector of floating point numbers, between $  \big[  0, 1 \big] $.  The HIST implementation was modified to use the cosine distance~\citep{Arandjelovic2012}.  Hence the descriptor is rescaled to $ \big[ -1, 1 \big] $.  Output values are cast to floating point numbers (i.e. floats).  This yields an effective 128-vector of floats between $\big[ -1 , 1 \big] $.
