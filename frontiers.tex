...
\def\corrAuthor{C1437FBH Lavarden 315, Ciudad Autónoma de Buenos Aires, Argentina}
...
\tiny
 \keyFont{ \section{Keywords:} EEG, BCI, SIFT, P300, ALS, NBNN, HOG} %All article types: you may provide up to 8 keywords; at least 5 are mandatory.
\end{abstract}
...
\begin{figure}[htb]
\centering
\includegraphics[width=.29\linewidth]{openvibep300matrixrow.png}
\includegraphics[width=.29\linewidth]{openvibep300matrixcol.png}
...
\caption{ Example of a patch and a scheme of the orientation's histogram computation.Plot of the signal, a keypoint and the corresponding patch.}
\label{fig:sampledescriptora}
\end{figure}

\begin{figure}[htb]
\centering
\includegraphics[width=.49\linewidth]{histogramsbines.png}\label{histogrambines}
\caption{ Example of a patch and a scheme of the orientation's histogram computation. Orientations on two blocks of the patch.}
\label{fig:sampledescriptorb}
\end{figure}
